...
import net.labhackercd.nhegatu.data.provider.EDMContract.Category;
import net.labhackercd.nhegatu.data.provider.EDMContract.Group;
import net.labhackercd.nhegatu.data.provider.EDMContract.Message;
import net.labhackercd.nhegatu.data.provider.EDMContract.Thread;
